						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>订单金额</label>
										<input name="dingdanjine" id="dingdanjine" name="dingdanjine" class="form-control" placeholder="订单金额">
									</div>
									<div class="form-group col-md-6">
										<label>采购日期</label>
									...
									<div class="form-group col-md-6">
										<label>采购备注</label>
										<input name="caigoubeizhu" id="caigoubeizhu" name="caigoubeizhu" class="form-control" placeholder="采购备注">
									</div>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("caigouzhangdan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("caigouzhangdan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("caigouzhangdan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#caigouriqi-input").val(getCurDate());
		...
		function dataBind(){
			...
			$("#caigoubeizhu").val(ruleForm.caigoubeizhu);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.rukudanhao != null && res.data.rukudanhao != ''){
						...
						$("#rukudanhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.caigoubeizhu != null && res.data.caigoubeizhu != ''){

						$("#caigoubeizhu").val(res.data.caigoubeizhu);
						$("#caigoubeizhu").attr('readonly','readonly');
					}
