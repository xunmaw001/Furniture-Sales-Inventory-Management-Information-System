...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="jingyingfanweiSearch" class="form-control form-control-sm" placeholder="请输入经营范围" aria-controls="tableId">
									<label>
										联系电话
									</label>
	...
	<script>
		...
		function search(){
			...
			if($('#jingyingfanweiSearch').val() != null && $('#jingyingfanweiSearch').val() != ''){
				searchForm.jingyingfanwei ="%" +  $('#jingyingfanweiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("gongyingshang/page","GET",{
				...
				jingyingfanwei : searchForm.jingyingfanwei,	
