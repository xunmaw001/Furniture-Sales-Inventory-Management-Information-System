						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jiajucailiao" name="jiajucailiao" class="form-control" v-model="ruleForm.jiajucailiao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>家具产地</label>

									<input id="jiajuchandi" name="jiajuchandi" class="form-control" v-model="ruleForm.jiajuchandi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>家具品牌</label>

									<input id="jiajupinpai" name="jiajupinpai" class="form-control" v-model="ruleForm.jiajupinpai" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>采购价格</label>
